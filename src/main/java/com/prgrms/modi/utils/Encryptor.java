...
public class Encryptor {
    ...
    private static final String KETSET_PATH = "Team_MODI_MODI_BE_KEYSET/encrypted-keyset.json";
    ...
    private static KeysetHandle readKeysetFromFile() throws IOException, GeneralSecurityException {
        ...
        InputStream keysetStream = ClassLoader.getSystemClassLoader().getResourceAsStream(KETSET_PATH);
