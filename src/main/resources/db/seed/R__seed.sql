INSERT
IGNORE INTO users(id, username, role, date_of_birth, points, created_at, updated_at, deleted_at, provider, provider_id)
VALUES
    (1, '테스트 유저1', 'USER', '1997-01-13', 50000, '2021-11-01 06:30:00', '2021-11-01 06:30:00', null, null, null),
...
INSERT
IGNORE INTO otts(id, name, english_name, subscription_fee, monthly_price, max_member_capacity, grade, created_at, updated_at)
VALUES
...
INSERT
IGNORE INTO rules(id, name, created_at, updated_at)
VALUES
...
INSERT
IGNORE INTO party_rule(party_id, rule_id)
VALUES
    (1, 1),
    (1, 2),
    (1, 3),
...
INSERT
IGNORE INTO members(id, is_leader, created_at, updated_at, deleted_at, party_id, user_id)
VALUES
