REPLACE
INTO users(id, username, role, date_of_birth, points, created_at, updated_at, deleted_at,
...
REPLACE
INTO otts(id, name, english_name, subscription_fee, monthly_price, max_member_capacity, grade, created_at, updated_at)
VALUES
...
REPLACE
INTO parties(id, party_member_capacity, current_member, total_price, monthly_reimbursement, remaining_reimbursement, start_date, end_date,
...
REPLACE
INTO rules(id, name, created_at, updated_at)
VALUES
...
REPLACE
INTO party_rule(party_id, rule_id)
VALUES
    (1, 1),
    (1, 2),
    (1, 3),
...
REPLACE
INTO members(id, is_leader, created_at, updated_at, deleted_at, party_id, user_id)
VALUES
