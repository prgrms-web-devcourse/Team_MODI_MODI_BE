...
VALUES (1, '테스트 유저1', 'USER', 0, '2021-11-01 06:30:00', '2021-11-01 06:30:00', null, 'naver',
       ...
       (6, '테스트 유저6', 'USER', 0, '2021-11-05 06:30:00', '2021-11-05 06:30:00', null, null, null)
       ;
...
VALUES (1, 4, 4, 10000, 5000, 25000, '2021-11-02', '2022-05-02', 6, 1, 'modi112@gmail.com',
       ...
       (9, 4, 2, 100000, 0, 0, '2022-01-14', '2022-05-22', 3, 1, 'modi112@gmail.com', 'modi',
        'RECRUITING', '2022-01-12 06:30:00', '2022-01-16 06:30:00', null, 1, 1),
       (10, 4, 2, 100000, 0, 0, '2022-01-14', '2022-05-22', 3, 1, 'modi112@gmail.com', 'modi',
        'RECRUITING', '2022-01-12 06:30:00', '2022-01-12 06:30:00', null, 1, 1)
        ;
...
VALUES (1, 1, '2021-11-02 06:30:00', '2021-11-02 06:30:00', null, 1, 1),
       ...
       (19, 1, '2022-01-12 06:30:00', '2021-01-12 06:30:00', null, 9, 4),
       (20, 0, '2022-01-13 06:30:00', '2021-01-13 06:30:00', null, 9, 1),

       (21, 1, '2022-01-12 06:30:00', '2021-01-12 06:30:00', null, 10, 6),
       (22, 0, '2022-01-13 06:30:00', '2021-01-13 06:30:00', null, 10, 4)

;

INSERT INTO notifications(id, content, read_check, created_at, member_id, party_id)
VALUES (1, '테스트 유저 1님이 파티원으로 참여했습니다.', false, '2022-01-13 06:30:00', 19, 9),
       (2, '공유계정 정보가 변경되었습니다.', false, '2022-01-14 06:30:00', 20, 9),
       (3, '공유계정 정보가 변경되었습니다.', false, '2022-01-15 06:30:00', 20, 9),
       (4, '공유계정 정보가 변경되었습니다.', false, '2022-01-16 06:30:00', 20, 9),
       (5, '테스트 유저 4님이 파티원으로 참여했습니다.', false, '2022-01-16 06:30:00', 21, 10)
;
